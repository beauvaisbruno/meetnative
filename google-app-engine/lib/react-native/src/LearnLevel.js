...
class LearnLevel {
  static lang(level) {
    if (level === LearnLevel.beginner) return lang_1.default("Beginner A1/A2");
    if (level === LearnLevel.intermediate)
      return lang_1.default("Intermediate B1/B2");
    if (level === LearnLevel.fluent) return lang_1.default("Fluent C1/C2");
...
//# sourceMappingURL=LearnLevel.js.map
