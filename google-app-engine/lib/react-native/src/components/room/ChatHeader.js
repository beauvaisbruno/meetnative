        ...
        React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(react_native_auto_height_image_1.default, {
              ...
              width: react_native_responsive_screen_1.widthPercentageToDP("13%")
            }),
            React.createElement(
              native_base_1.Text,
              { style: { marginLeft: 5, fontWeight: "bold", fontSize: xl } },
              profile.pseudo
            )
          ),
          React.createElement(
            ...
            React.createElement(
              native_base_1.Text,
              { style: { fontSize: s, paddingLeft: 5, paddingRight: 5 } },
              lang_1.default("Info")
            )
          )
        ),
