...
class TeachLevel {
  static lang(level) {
    if (level === TeachLevel.native) return lang_1.default("Native");
    if (level === TeachLevel.bilingual) return lang_1.default("Bilingual");
    if (level === TeachLevel.fluent) return lang_1.default("Fluent");
...
//# sourceMappingURL=TeachLevel.js.map
