...
class AvatarSelector extends React.Component {
    ...
    render() {
        return (React.createElement(native_base_1.View, { style: {
            ...
            React.createElement(native_base_1.View, { style: { textAlignVertical: "top", flex: 1, flexDirection: "row" } },
                React.createElement(native_base_1.Text, { style: { textAlignVertical: "top", marginRight: 10 } }, "Avatar"),
                React.createElement(react_native_1.TouchableHighlight, { testID: "TouchableHighlight", onPress: () => {
                        this.props.navigation.navigate("AvatarScreen");
                    } },
                    React.createElement(react_native_auto_height_image_1.default, { source: Avatars_1.avatars[this.props.value], width: react_native_responsive_screen_1.widthPercentageToDP("45%") })))));
    }
}
