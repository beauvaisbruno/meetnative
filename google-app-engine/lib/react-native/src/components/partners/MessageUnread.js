...
exports.MessageUnread = ({
  ...
  react_1.default.createElement(
    Mutation_1.default,
    {
      mutation: exports.setLastMessageRead,
    ...
    (setLastMessageRead, { data, error, loading }) => {
      ...
      return react_1.default.createElement(
        ...
        react_1.default.createElement(
          native_base_1.Text,
          { style: { color: custom_1.default.brandDanger, fontSize: size } },
        ...
        react_1.default.createElement(
          native_base_1.Button,
          {
            ...
            onPress: () => {
              console.log(
                "setLastMessageRead, recipientId: ",
                userProfile.id,
                ", authorId: ",
                contactProfile.id
              );
              console.log("optimisticResponse: ", {
                setLastMessageRead: Object.assign({}, message, {
          ...
          loading ||
            react_1.default.createElement(native_base_1.Icon, {
              ...
              style: Object.assign({}, utilsUi_1.noMarPad, { fontSize: size })
            }),
          loading &&
            react_1.default.createElement(native_base_1.Icon, {
              name: "spinner",
...
//# sourceMappingURL=MessageUnread.js.map
