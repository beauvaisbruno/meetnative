  ...
  React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(react_native_auto_height_image_1.default, {
        ...
        width: react_native_responsive_screen_1.widthPercentageToDP("80%")
      }),
      React.createElement(native_base_1.List, {
        dataArray: utils_1.objsToArrayWithKey(props.routes),
        renderRow: data => exports.renderRows(data, props.navigation)
      }),
