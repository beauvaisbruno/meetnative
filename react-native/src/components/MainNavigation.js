...
const ProfileContainer_1 = __importDefault(require("./profile/ProfileContainer"));
...
const withDrawer = {
    ...
    PartnersScreen: { screen: PartnersScreen_1.default, menuLabel: "Last messages" },
    ProfileContainer: { screen: ProfileContainer_1.default, menuLabel: "Your Profile" }
};
const noDrawer = {
    AvatarScreen: { screen: AvatarScreen_1.default },
    RoomScreen: { screen: RoomScreen_1.default }
};
exports.default = (pRoutes = Object.assign({}, withDrawer, noDrawer), drawerConfig = {
    initialRouteName: "ProfileContainer",
    contentComponent: (props) => (React.createElement(SideBar_1.default, Object.assign({ routes: withDrawer }, props))),
    drawerWidth: react_native_responsive_screen_1.widthPercentageToDP("80%")
}) => react_navigation_1.createAppContainer(react_navigation_1.createDrawerNavigator(pRoutes, drawerConfig));
