...
function PageTemplate(Screen, headerTitle, padding = true, noScroll = false) {
    return class extends React.Component {
        render() {
            return (React.createElement(native_base_1.Container, { style: { backgroundColor: custom_1.default.backgroundApp } },
                React.createElement(HeaderApp_1.default, { headerTitle: headerTitle }),
                noScroll || (React.createElement(native_base_1.Content, { padder: padding },
