...
class SearchScreen extends React.Component {
    ...
    render() {
        ...
        const { lat: userLat, lon: userLon, langsToTeach: userTeach, langsToLearn: userLearn } = this.props.userProfile;
        const rows = [];
        if (data) {
            ...
            data.forEach((profile) => {
                rows.push(React.createElement(native_base_1.View, { key: profile.id, style: { flexDirection: "row" } },
                    React.createElement(native_base_1.View, { key: "avatar", style: { position: "relative", width: react_native_responsive_screen_1.widthPercentageToDP("50%") } },
                        ...
                        React.createElement(native_base_1.Button, { block: true, rounded: true, success: true, onPress: () => this.props.navigation.navigate("RoomScreen", {
                                contactProfile: profile
                            }), testID: "contact-" + profile.id, style: {
        ...
        return (React.createElement(native_base_1.View, null,
            ...
            error && (React.createElement(native_base_1.Text, { style: { color: custom_1.default.brandDanger } }, lang_1.default("Impossible to load profiles"))),
            rows.length > 0 && (fetching || rows),
            rows.length === 0 &&
                (fetching || (React.createElement(native_base_1.View, null,
                    React.createElement(native_base_1.Text, { style: { fontStyle: "italic", textAlign: "center" } }, lang_1.default("No user match your profile")))))));
    }
}
exports.SearchScreen = SearchScreen;
exports.mapStateToProps = (state) => (Object.assign({}, state.search, { userProfile: state.profile.profileLoad.data }));
exports.mapDispatchToProps = (dispatch) => {
    return {
        doSearchProfile: () => dispatch(reducerHelper_1.fetchingAction(searchReducer_1.SearchActions.searchProfiles))
    };
};
exports.default = react_redux_1.connect(exports.mapStateToProps, exports.mapDispatchToProps)(PageTemplate_1.default(react_navigation_1.withNavigation(SearchScreen), lang_1.default("Find a partner"), false));
