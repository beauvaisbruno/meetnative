...
const AuthLoadingScreen_1 = __importDefault(
  require("./login/AuthLoadingScreen")
);
...
const NavigationContainer = react_navigation_1.createAppContainer(
  react_navigation_1.createSwitchNavigator(routeConfigMap, switchConfig)
);
...
exports.default = () =>
  React.createElement(
    NavigationContainer,
    Object.assign({}, { ref, onNavigationStateChange })
  );
